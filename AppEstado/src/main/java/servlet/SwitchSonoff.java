...
public class SwitchSonoff extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //Obtiene el valor del boton que se ha pulsado
        String comando = request.getParameter("comando");

        //Si el valor no es nulo envia el comando por mqtt para encender
        // o apagar el sonoff
        if (comando!=null){
            mqttManager.publish(Topic.TOPIC_SONOFF_CMND_POWER, comando, false);  
        }
        
        response.sendRedirect(response.encodeURL("estados.jsp"));
